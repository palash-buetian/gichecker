    ...
    <div class="page-sidebar md-shadow-z-2-i  navbar-collapse collapse">
        <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
            ...
            while ($interest_info = mysqli_fetch_array($interest_result)) {
                ...
                echo ' <li> ';
                echo ' <a href="/interest_details.php?interest=';
                echo $interest_info['interest_id'];
                echo '" class="service-list" data-s_id="13"><i style="float: left; margin: 2px 6px 4px 7px;" class="icon-book-open"></i><span class="title">';
