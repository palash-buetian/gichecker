...
CREATE TABLE IF NOT EXISTS `dag` (
  ...
  `bs_dag` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `sa_khatian` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `bs_khatian` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
