                                        ...
                                        <div style="font-size: 15px; text-align: justify;margin: 20px;">
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="sample_6">
                                                ...
                                                if (isset($_REQUEST["interest"])) {
                                                    $interest_id = (int)$_REQUEST["interest"];
                                                } else {
                                                    $interest_id = 0;
                                                }
                                                ...
                                                // get the info from the db
                                                $query = "SELECT * FROM `dag` WHERE `interest_id`=$interest_id ORDER BY `interest_id` ASC";
                                               ...
                                               // print_r($query);
                                                ...
                                                // get the info from the db
                                                $query_final = "SELECT * FROM `dag` WHERE `interest_id`=$interest_id ORDER BY `interest_id` DESC LIMIT $offset, $rowsperpage";
                                              ...
                                              //  print_r($query_final);
                                                ...
                                                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                                    ...
                                                    if ($mouja_id == 0 & $interest_id == 0) {
                                                        ...
                                                        $query = "SELECT * FROM `dag` WHERE `interest_id`=$interest_id ORDER BY id DESC LIMIT 135";
                                                    }

                                                    $query = "SELECT * FROM dag WHERE `interest_id`=$interest_id & WHERE {$sa_part} {$joiner} {$bs_part} {$mouja_part}";

                                                } else {

                                                    $query_final = "SELECT * FROM `dag` WHERE `interest_id`=$interest_id ORDER BY id DESC LIMIT $offset, $rowsperpage";
                                                }
